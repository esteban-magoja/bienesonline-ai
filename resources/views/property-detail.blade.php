...
<x-layouts.marketing :seo="$seo">
                            ...
                            @if($property->user->movil)
                                @auth
                                    <a 
                                        ...
                                        target="_blank"
                                        onclick="recordContact({{ $property->id }}, 'whatsapp')"
                            ...
                            <div class="mt-3 pt-2">
                                @auth
                                    <a 
                                        ...
                                        onclick="recordContact({{ $property->id }}, 'phone')"
    ...
    <script>
        function recordContact(listingId, action) {
            fetch('{{ route('property.contacts.store') }}', {
                method: 'POST',
                headers: {
