...
return [
    /*
    |--------------------------------------------------------------------------
    | Property Listings Translations - English
    |--------------------------------------------------------------------------
    |
    | Translations for property listings management
    |
    */
    ...
    // Search
    'search' => 'Search',
    'search_placeholder' => 'Search in my listings...',
    'searching' => 'Searching...',
    'clear' => 'Clear',
    ...
    // Confirmations
    'confirm_delete_title' => 'Delete listing?',
    ...
    'form' => [
        ...
        'youtube_url_help' => 'Paste the URL of your YouTube video (e.g. https://www.youtube.com/watch?v=...)',
        'optional' => 'optional',
        ...
        'drag_drop' => 'Drag and drop images here or click to select',
        'max_images' => 'Maximum :count images',
        
        // Status
        'status' => 'Status',
        'make_active' => 'Mark as active',
    ...
    'unpublished_success' => 'Listing unpublished successfully',
    
    'error_creating' => 'Error creating listing',
