...
return [
    ...
    */
    ...
    'terms' => [
        'title' => 'Terms and Conditions for Participation in BienesOnLine.ai',
        'intro' => 'By registering on <strong>BienesOnLine.ai</strong>, the user declares that they have read, understood and accepted the following terms, which govern their participation in the platform\'s collective real estate sales program:',
        ...
        'listings_text' => 'Members can publish real estate listings without limit, as long as they comply with the quality, accuracy and update standards established by BienesOnLine.ai.',
        'commissions_title' => 'Shared commissions:',
        'commissions_text' => 'The properties listed must be available to share commissions 50/50 in percentage with agents, partners or clients provided by BienesOnLine.ai, as well as in cases of collective operations.',
        ...
        'raxta_clients_title' => 'Operations with clients provided by BienesOnLine.ai:',
        'raxta_clients_text' => 'In case BienesOnLine.ai directly provides a client and a sale is completed, the platform will charge a commission of <strong>1%</strong> of the final operation value, or the equivalent of <strong>50% of the monthly cost</strong> in case of rental.',
        'member_operations_title' => 'Operations between members:',
        'member_operations_text' => 'BienesOnLine.ai <strong>will not charge additional commissions</strong> when operations are carried out exclusively between platform member partners.',
        ...
        'acceptance_text' => 'By clicking "Accept", the user confirms their full adherence to these Terms and Conditions, acknowledging that they are part of the participation agreement in BienesOnLine.ai.',
