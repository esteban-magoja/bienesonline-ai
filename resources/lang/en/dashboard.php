...
return [
    ...
    */
    ...
    'matches_section' => [
        ...
        'sort_newest' => 'Newest',
        'sort_score' => 'Match',
        'current_sort' => 'Current order: :sort',
        'change_sort_to' => 'Change to :sort',
        'total_matches_count' => ':count matches',
    ...
    'search_requests' => [
        ...
        'premium_description' => 'To search for requests from interested users and contact them you need a subscription.',
        ...
        'premium_granted' => 'Premium subscription activated successfully! You can now search for client requests.',
        'country' => 'Country',
    ...
    // Terms of Use Page
    'terms' => [
        'title' => 'Terms of Use of bienesonline.ai',
        'intro' => 'By registering on bienesonline.ai, the user declares that they have read, understood and accepted the following terms, which govern the use of the platform and their participation in the real estate match system.',
        's1_title' => '1. Access and subscription',
        's1_text'  => 'Access to the full features of the platform requires an active monthly subscription. The subscription allows publishing properties, receiving contacts and accessing the intelligent match system.',
        's2_title' => '2. Publication of properties and requests',
        's2_text'  => 'Users can publish properties, searches or requirements without limit, as long as the information is truthful, clear and kept up to date.',
        's3_title' => '3. Real estate match system',
        's3_text'  => 'The platform uses artificial intelligence to connect properties with potential buyers, sellers or interested parties. These matches are automated suggestions and do not guarantee results or closing of transactions.',
        's4_title' => '4. Direct contact between users',
        's4_text'  => 'bienesonline.ai facilitates direct contact between the parties, including integration with channels such as WhatsApp or other means defined by the user. The platform does not act as an intermediary in negotiations.',
        's5_title' => '5. Responsibility for information',
        's5_text'  => 'Each user is responsible for the content they publish, as well as the accuracy of the data and conditions of the transactions. bienesonline.ai does not validate or guarantee the accuracy of the listings.',
        's6_title' => '6. Transactions and agreements',
        's6_text'  => 'Transactions, commercial conditions, commissions and agreements are carried out directly between the parties involved, without intervention or liability of the platform.',
        's7_title' => '7. Appropriate use of the platform',
        's7_text'  => 'The use of the platform to publish false, duplicate, misleading information or information that infringes third-party rights is prohibited. Non-compliance may result in suspension or cancellation of the account.',
        's8_title' => '8. Service availability',
        's8_text'  => 'bienesonline.ai may modify, update or discontinue features without prior notice, with the aim of improving the service and user experience.',
        's9_title' => '9. Limitation of liability',
        's9_text'  => 'The platform does not guarantee commercial results, closing of transactions or the quality of contacts generated through the match system.',
        'acceptance_text' => 'By clicking "Accept", the user confirms their full adherence to these terms and conditions.',
        'checkbox_label' => 'I have read and accept the terms of use',
