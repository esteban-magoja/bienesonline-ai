...
return [
    ...
    */
    ...
    'matches_section' => [
        ...
        'sort_score' => 'Coincidencia',
        'current_sort' => 'Orden actual: :sort',
        'change_sort_to' => 'Cambiar a :sort',
        'total_matches_count' => ':count coincidencias',
    ...
    'search_requests' => [
        ...
        'premium_description' => 'Para buscar solicitudes de usuarios interesados y poder contactarlos necesitas una suscripción.',
        ...
        'premium_granted' => '¡Suscripción premium activada exitosamente! Ahora puedes buscar solicitudes de clientes.',
        'country' => 'País',
        ...
        'page_info' => 'Mostrando :from–:to de :total resultados',
        'prev' => 'Anterior',
        'next' => 'Siguiente',
        'validation' => [
    ...
    // Terms of Use Page
    'terms' => [
        'title' => 'Términos de uso de bienesonline.ai',
        'intro' => 'Al registrarse en bienesonline.ai, el usuario declara haber leído, comprendido y aceptado los siguientes términos, que regulan el uso de la plataforma y su participación en el sistema de match inmobiliario.',
        's1_title' => '1. Acceso y suscripción',
        's1_text'  => 'El acceso a las funcionalidades completas de la plataforma requiere una suscripción mensual activa. La suscripción permite publicar propiedades, recibir contactos y acceder al sistema de match inteligente.',
        's2_title' => '2. Publicación de propiedades y demandas',
        's2_text'  => 'Los usuarios pueden publicar propiedades, búsquedas o requerimientos sin límite, siempre que la información sea veraz, clara y se mantenga actualizada.',
        's3_title' => '3. Sistema de match inmobiliario',
        's3_text'  => 'La plataforma utiliza inteligencia artificial para vincular propiedades con potenciales compradores, vendedores o interesados. Estos matches son sugerencias automatizadas y no garantizan resultados ni cierre de operaciones.',
        's4_title' => '4. Contacto directo entre usuarios',
        's4_text'  => 'bienesonline.ai facilita el contacto directo entre las partes, incluyendo integración con canales como WhatsApp u otros medios definidos por el usuario. La plataforma no interviene como intermediario en las negociaciones.',
        's5_title' => '5. Responsabilidad sobre la información',
        's5_text'  => 'Cada usuario es responsable por el contenido que publica, así como por la veracidad de los datos y condiciones de las operaciones. bienesonline.ai no valida ni garantiza la exactitud de las publicaciones.',
        's6_title' => '6. Operaciones y acuerdos',
        's6_text'  => 'Las operaciones, condiciones comerciales, comisiones y acuerdos se realizan directamente entre las partes involucradas, sin intervención ni responsabilidad de la plataforma.',
        's7_title' => '7. Uso adecuado de la plataforma',
        's7_text'  => 'Queda prohibido el uso de la plataforma para publicar información falsa, duplicada, engañosa o que infrinja derechos de terceros. El incumplimiento podrá derivar en la suspensión o cancelación de la cuenta.',
        's8_title' => '8. Disponibilidad del servicio',
        's8_text'  => 'bienesonline.ai podrá modificar, actualizar o discontinuar funcionalidades sin previo aviso, con el objetivo de mejorar el servicio y la experiencia del usuario.',
        's9_title' => '9. Limitación de responsabilidad',
        's9_text'  => 'La plataforma no garantiza resultados comerciales, cierres de operaciones ni la calidad de los contactos generados a través del sistema de match.',
        'acceptance_text' => 'Al hacer clic en "Aceptar", el usuario confirma su adhesión plena a estos términos y condiciones.',
        'checkbox_label' => 'He leído y acepto los términos de uso',
        'accept_button' => 'Aceptar Términos',
