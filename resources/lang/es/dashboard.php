...
return [
    ...
    */
    ...
    'terms' => [
        'title' => 'Términos y Condiciones de Participación en BienesOnLine.ai',
        'intro' => 'Al registrarse en <strong>BienesOnLine.ai</strong>, el usuario declara haber leído, comprendido y aceptado los siguientes términos, que rigen su participación en el programa de ventas colectivas inmobiliarias de la plataforma:',
        ...
        'listings_text' => 'Los socios pueden publicar anuncios inmobiliarios sin límite de cantidad, siempre que cumplan con las normas de calidad, veracidad y actualización establecidas por BienesOnLine.ai.',
        'commissions_title' => 'Comisiones compartidas:',
        'commissions_text' => 'Los inmuebles publicados deberán estar disponibles para compartir comisiones en 50/50 en porcentaje con agentes, socios o clientes provistos por BienesOnLine.ai, así como en casos de operaciones colectivas.',
        ...
        'raxta_clients_title' => 'Operaciones con clientes provistos por BienesOnLine.ai:',
        'raxta_clients_text' => 'En caso de que BienesOnLine.ai provea un cliente en forma directa y se concrete una venta, la plataforma cobrará una comisión del <strong>1%</strong> del valor final de la operación, o el equivalente al <strong>50% del costo mensual</strong> en caso de alquiler.',
        'member_operations_title' => 'Operaciones entre socios:',
        'member_operations_text' => 'BienesOnLine.ai <strong>no cobrará comisiones adicionales</strong> cuando las operaciones se realicen exclusivamente entre miembros socios de la plataforma.',
        ...
        'acceptance_text' => 'Al hacer clic en "Aceptar", el usuario confirma su adhesión plena a estos Términos y Condiciones, reconociendo que forman parte del acuerdo de participación en BienesOnLine.ai.',
